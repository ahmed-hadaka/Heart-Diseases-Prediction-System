...
TRUNCATE TABLE patient_prescriptions;
...
INSERT INTO doctor(id,work_time,specialization) VALUES(2,"","Heart Failure");
...
INSERT INTO prediction ( prediction_result,risk_score,patient_id,created_at)VALUES("UnHealthy","75%",5, NOW());
